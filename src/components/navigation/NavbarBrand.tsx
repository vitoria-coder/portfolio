...
export default function NavbarBrand() {
    return (
        <Link href="/" arial-label="Vitória Sousa - início" className="group inline-flex min-h-11 items-center gap-3">
            ...
            <span className="flex flex-col justify-center leading-none">
                ...
                <span className="mt-1 font-nono text-[0.55rem] uppercase tracking-[0.24em] text-white/40">
                    Software Engineer
                </span>
            </span>
        </Link>
